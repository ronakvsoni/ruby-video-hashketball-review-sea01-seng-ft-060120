...
#def num_points_scored(player_name)
  #values = game_hash.values.each do |value|
    #value[:players].each do |player|
     # binding.pry
    #  if player[:player_name] == player_name
   #   pointofplayer = player[:points] 
...
def player(player_name)
  my_player = alll_players.find do |player|
...
def player_numbers(team_name)
  araayofjersey = []
  team = teamnames(team_name)
 
  team[:players].collect do |jersey|
   
  araayofjersey << jersey[:number]
